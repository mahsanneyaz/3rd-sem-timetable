...
const timetableData = {
  ...
  "subjects": {
    ...
    "ELI": { "code": "24MDCxx", "name": "Electoral Literacy in India (ELI)", "faculty": "NF", "department": "POL.SC." },
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function generateTimetable() {
    ...
    grid.appendChild(Object.assign(document.createElement('div'), { className: 'grid-header', textContent: 'Time' }));
